    ...
    //checks for the button click event
				$("#serchButton").click(function(e){

					alert("Hi");
					   
						//get the form data and then serialize that
						dataString = $("#serchForm").serialize();
						
						//get the form data using another method 
						var countryCode = $("input#serchTxt").val(); 
            ...
            function init1(){
                ...
                var bounds = new OpenLayers.Bounds(
                    -37273.73737817281, 3463535.509780019,
                    -36306.581487792544, 3463987.424214183
                );
                var options = {
                    controls: [],
                    maxExtent: bounds,
                    maxResolution: 3.777952696797911,
                ...
                tiled = new OpenLayers.Layer.WMS(
                    "Parcels:Parcels - Tiled", "http://localhost:8080/geoserver/Parcels/wms",
                    {
				...
				//var openLayer=new OpenLayers.Layer.Google()
                untiled = new OpenLayers.Layer.WMS(
                    "Parcels:Parcels - Untiled", "http://localhost:8080/geoserver/Parcels/wms",
                    {
                        LAYERS: 'Parcels:Parcels',
                        STYLES: '',
                        format: format
                ...
                map.events.register('click', map, function (e) {
                    ...
                    OpenLayers.loadURL("http://localhost:8080/geoserver/Parcels/wms", params, this, setHTML, setHTML);
            ...
            function setHTML(response){
                document.getElementById('nodelist').innerHTML ="<div style='"+"width:100%"+"'>"+ response.responseText+"</div>";
            };
							...
							success: function( data, textStatus, jqXHR) {
								//our country code was correct so we have some information to display
								 if(data.success){
									 ...
									 serArr = [];
									 for(var i=0;i<data.ParcelInfo.length;i++)
										 {
										 	serArr.push(data.ParcelInfo[i].owner);
										 	serArr.push(data.ParcelInfo[i].parcelId);
										 }
										 $( "#serchTxt" ).autocomplete({
										  source: serArr
										});
